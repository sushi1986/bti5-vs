...
public class Worker extends Thread {
    ...
    private boolean insertMessageIntoSlot(Message msg, TimeSlot[] into) {
        if (into[msg.getNextSlot()] != null) {
            ...
            System.out.println("[WORKER]" + "Slot is: " + currentSlot + ": " + msg.toString());
    ...
    public void run() {
        ...
        while (!synced && !isInterrupted()) {
            ...
            if (msg != null) {
                ...
                silence = false;
                System.out.println("[WORKER][sync]" + "Slot is: " + currentSlot + "; " + msg.toString());
        ...
        while (!isInterrupted()) {
            ...
            // expecting self / send something
                ...
                if (msg == null) {
                    ...
                    if (msg.getSender().startsWith(self)) {
                        ...
                        if(msg.getSender().startsWith(current[(currentSlot-1) > 0 ? (currentSlot-1) : (NUMBER_OF_SLOTS-1) ].getTeam())) {
                            // TODO adjust timing
                        }
                    }
                }
            ...
            // expecting specific team
                ...
                if (msg.getSender().startsWith(self)) {
                    ...
                    // TODO ist das die erwartete Nachticht?
